...
export default {
  ...
  methods: {
    calculate() {
      const c = ((this.b - this.a) / this.a) * 100; // Hitung perubahan persentase
      const d = this.b - this.a; // Hitung selisih absolut
      this.results.push({
        nama: this.nama,
        a: this.a,
        b: this.b,
        c: `${c.toFixed(2)}%`, // Tambahkan simbol '%' pada hasil C
        d,
      });
    },
    exportToPDF() {
      ...
      // Header
      doc.text('Perubahan Persentase', 10, 10);
      ...
      // Save PDF
      doc.save('Perubahan_Persentase.pdf');
    },
  },
};
</script>
